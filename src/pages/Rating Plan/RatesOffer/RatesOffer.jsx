...
export default function RatesOffer(){
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const response = await axios.get('http://172.17.1.11:9696/api/rates/offer/get/all', {
                    headers: {
    ...
    const handleConfirmDelete = () => {
        ...
        axios.delete('http://172.17.1.11:9696/api/rates/offer/delete/'+recordIdToDelete, {
            headers: {
                Authorization: `Bearer ${tokenValue}`,
                "Accept": "application/json",
                "Content-Type": "application/json"
