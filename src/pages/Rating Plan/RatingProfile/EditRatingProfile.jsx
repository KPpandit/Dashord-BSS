...
export default function EditRatingProfile(props) {
    ...
    useEffect(() => {
        axios.get('http://172.17.1.11:9696/api/rating/profile/get/' + rating_profile_id)
            .then(res => {
    ...
    useEffect(() => {
        fetch("http://172.17.1.11:9696/api/category/detail/get/all")
            .then((resp) => resp.json())
            .then((resp) => {
        ...
        fetch("http://172.17.1.11:9696/api/rates/offer/bulk/get/all")
            .then((res) => res.json())
            .then((resp) => {
                setdata1(resp);
            })
        ...
        fetch("http://172.17.1.11:9696/api/rates/plan/offer/get/all")
            .then((res) => res.json())
            .then((resp) => {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        await axios.put('http://172.17.1.11:9696/api/rating/profile/edit/' + selectObj.rating_profile_id, {
