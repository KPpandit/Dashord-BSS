...
export default function Languages() {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const response = await axios.get('http://172.17.1.20:9090/api/alllanguage', {
                    headers: {
    ...
    // useEffect(() => {
    //     fetch("http://172.17.1.20:9090/api/alllanguage",{headers: {
    //         Authorization: `Bearer ${tokenValue}`,
    //         "Accept": "application/json",
    //         "Content-Type": "application/json"
    //     }})
    ...
    const handleEditSave = (editedData) => {
        ...
        axios.put(`http://172.17.1.20:9090/api/updatelanguage/${editedData.id}`, {
