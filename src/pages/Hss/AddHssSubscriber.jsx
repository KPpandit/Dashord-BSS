...
const AdddHssSubscriber = (props) => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const response = await axios.get('http://172.5.10.2:9697/api/hss/detail/get/all/subscribers', {
                    headers: {
    ...
    const SelectedRecordDetails = () => {
        const handleBlockServices = (imsi) => {
            axios.put(`http://172.5.10.2:9697/api/hss/detail/block/subscriber/`+imsi, {
                headers: {
                    Authorization: `Bearer ${tokenValue}`,
                    "Accept": "application/json",
                    "Content-Type": "application/json"
        ...
        const handleUnBlockServices = (imsi) => {
            axios.put(`http://172.5.10.2:9697/api/hss/detail/unblock/subscriber/`+imsi, {
                headers: {
                    Authorization: `Bearer ${tokenValue}`,
                    "Accept": "application/json",
                    "Content-Type": "application/json"
