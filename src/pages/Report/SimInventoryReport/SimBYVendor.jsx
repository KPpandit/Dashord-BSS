...
export default function SimByVendor (props) {
    const columns = [
    ...
    useEffect(() => {
        ...
        const fetchData = async () => {
            try {
                const response = await axios.get('http://172.17.1.20:9098/sim/getall/sim/byVendor', {
                    headers: {
    ...
    const handleDateRange = () => {
        ...
        const apiUrl = `http://172.17.1.20:9098/sim/getall/sim/byVendor/dateRange?search=${serach}&startDate=${startdate}&endDate=${enddate}`;
