...
export default function SimByAgent (props) {
    const columns = [
        ...
        { id: 'partnerName', name: 'Vendor Name' },
        { id: 'partnerEmail', name: 'Vendor Email' },
    ...
    useEffect(() => {
        ...
        const fetchData = async () => {
            try {
                const response = await axios.get('http://172.17.1.20:9098/sim/getall/sim/byAgent', {
                    headers: {
    ...
    const handleDateRange = () => {
        ...
        const apiUrl = `http://172.17.1.20:9098/sim/getall/sim/byAgent/dateRange?search=${serach}&startDate=${startdate}&endDate=${enddate}`;
