...
const SimBySellingPrice = (props) => {
    ...
    const handleDateRange = () => {
        ...
        const apiUrl = `https://bssproxy01.neotel.nr/mis-reports/sim/getSim/price/byDate?search=${serach}&startDate=${startdate}&endDate=${enddate}`;
                ...
                <Box component="main" sx={{ flexGrow: 1, p: 1, width: '100%' }}>
                    <Paper elevation={10} sx={{ padding: 1, margin: 1, backgroundColor: 'white', color: '#253A7D', marginLeft: -0.8, marginRight: -1 }}>
                        <Grid>
                            ...
                            >SIM By Selling Price</Typography>
                        </Grid>
                    </Paper>
                </Box>
...
export default SimBySellingPrice;
