...
export default function SimByStatus (props) {
    ...
    useEffect(() => {
        ...
        const fetchData = async () => {
            try {
                const response = await axios.get('http://172.17.1.20:9098/sim/getall/sim/byStatus', {
                    headers: {
    ...
    const handleDateRange = () => {
        ...
        const apiUrl = `http://172.17.1.20:9098/sim/getall/sim/byStatus/dateRange?search=${serach}&startDate=${startdate}&endDate=${enddate}`;
