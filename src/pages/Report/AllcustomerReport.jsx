...
const AllCustomerReport = (props) => {
    ...
    const handleSerch = async (e) => {
        e.preventDefault();
        return await axios
            .get(`https://bssproxy01.neotel.nr/mis-reports/customer/bySearch/Radha`, {
                headers: {
                    Authorization: `Bearer ${tokenValue}`,
                    Accept: 'application/json',
                    'Content-Type': 'application/json',
    ...
    const handleDateRange = () => {
        ...
        const apiUrl = `https://bssproxy01.neotel.nr/mis-reports/customer/search?search=${serach}&startDate=${startdate}&endDate=${enddate}`;
