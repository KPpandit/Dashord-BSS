...
export default function CustomerSignUp(props) {
    ...
    useEffect(() => {
        ...
        const fetchData = async () => {
            try {
                const response = await axios.get('https://bssproxy01.neotel.nr/mis-reports/customer/signup/reports', {
                    headers: {
  ...
  const handleDateRange = () => {
    ...
    const apiUrl = `https://bssproxy01.neotel.nr/mis-reports/customer/byDate/range?search=${serach}&startDate=${startdate}&endDate=${enddate}`;
