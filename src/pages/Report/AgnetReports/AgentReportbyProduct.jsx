...
export default function AgentReportByProduct(props) {
    ...
    useEffect(() => {
        ...
        const fetchData = async () => {
            try {
                const response = await axios.get('https://bssproxy01.neotel.nr/mis-reports/agent/partners/byall/records', {
                    headers: {
    ...
    const handleDateRange = () => {
        ...
        const apiUrl = `https://bssproxy01.neotel.nr/mis-reports/agent/partners/byall/records/bydate/range?search=${serach}&startDate=${startdate}&endDate=${enddate}`;
        // Make the API call
        fetch(apiUrl, {
            headers: {
