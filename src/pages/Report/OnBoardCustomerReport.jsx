...
export default function OnBoardCustomerReports() {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const response = await axios.get("https://bssproxy01.neotel.nr/mis-reports/customer/graph", {
                    headers: {
            ...
            try {
                const response = await axios.get("https://bssproxy01.neotel.nr/mis-reports/customer/chart", {
                    headers: {
                        Authorization: `Bearer ${localStorage.getItem('token')}`,
                        "Accept": "application/json",
                        "Content-Type": "application/json"
    ...
    const handleDateRange = () => {
        ...
        const apiUrl = `https://bssproxy01.neotel.nr/mis-reports/customer/bydatefilter/${type}?startDate=${startdate}&endDate=${enddate}`;
    ...
    const handleCategory = async (categoryType) => {
        try {
            const response = await axios.get(`https://bssproxy01.neotel.nr/mis-reports/customer/graph/Data?startDate=${startdate}&endDate=${enddate}`, {
                headers: {
                    Authorization: `Bearer ${localStorage.getItem('token')}`,
                    "Accept": "application/json",
                    "Content-Type": "application/json"
