...
export default function PrepaidCustomerUsageReport (props) {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                let url = 'https://bssproxy01.neotel.nr/mis-reports/api/pre-paid/all/info';
    ...
    const handleDateRange = () => {
        ...
        const apiUrl = `https://bssproxy01.neotel.nr/mis-reports/customer/prepaid/search?search=${serach}&startDate=${startdate}&endDate=${enddate}`;
