...
export default function TopCustomerReport(props) {
    ...
    useEffect(() => {
        ...
        const fetchData = async () => {
            try {
                const response = await axios.get('https://bssproxy01.neotel.nr/mis-reports/customers/dataCosumption/postpaid', {
                    headers: {
    ...
    const handleDateRange = () => {
        ...
        const apiUrl = `https://bssproxy01.neotel.nr/mis-reports/customer/byDataUsage?search=${serach}&startDate=${startdate}&endDate=${enddate}`;
