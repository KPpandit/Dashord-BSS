...
const PostpaidCustomerReport = (props) => {
    ...
    useEffect(() => {
        ...
        const fetchData = async () => {
            try {
                const response = await axios.get('https://bssproxy01.neotel.nr/mis-reports/customer/postpaid', {
                    headers: {
    ...
    const handleDateRange = () => {
        ...
        const apiUrl = `https://bssproxy01.neotel.nr/mis-reports/customer/postpaid/search?search=${serach}&startDate=${startdate}&endDate=${enddate}`;
