...
export default function TopPostPaidCallUsageReport(props) {
    ...
    useEffect(() => {
        ...
        const fetchData = async () => {
            try {
                const response = await axios.get('https://bssproxy01.neotel.nr/mis-reports/customer/call/usage', {
                    headers: {
    ...
    const handleDateRange = () => {
        ...
        const apiUrl = `https://bssproxy01.neotel.nr/mis-reports/customer/call/usage/bydate/range?search=${serach}&startDate=${startdate}&endDate=${enddate}`;
