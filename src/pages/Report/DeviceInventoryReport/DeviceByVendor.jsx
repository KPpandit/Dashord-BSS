import { Box, Button,  FormControl, Grid,  MenuItem,  Paper, Select, Table, TableBody, TableCell, TableContainer, TableHead, TablePagination, TableRow, TextField, Typography } from '@mui/material';
...
export default function DeviceByVendor(props) {
    const columns = [
    ...
    useEffect(() => {
        ...
        const fetchData = async () => {
            try {
                const response = await axios.get('https://bssproxy01.neotel.nr/mis-reports/device/get/alldevice/byVendor', {
                    headers: {
    ...
    const handleDateRange = () => {
        ...
        const apiUrl = `https://bssproxy01.neotel.nr/mis-reports/device/get/alldevice/byVendor/dateRange?search=${serach}&startDate=${startdate}&endDate=${enddate}`;
                ...
                <Box component="main" sx={{ flexGrow: 1, p: 1, width: '100%' }}>
                    <Paper elevation={10} sx={{ padding: 1, margin: 1, backgroundColor: 'white', color: '#253A7D', marginLeft: -0.8, marginRight: -1 }}>
                        <Grid>
                            ...
                            >All Device By Vendor</Typography>
                        </Grid>
                    </Paper>
                </Box>
