...
export default function DeviceByAgent(props) {
    ...
    useEffect(() => {
        ...
        const fetchData = async () => {
            try {
                const response = await axios.get('https://bssproxy01.neotel.nr/mis-reports/device/get/alldevice/byAgent', {
                    headers: {
    ...
    const handleDateRange = () => {
        ...
        const apiUrl = `https://bssproxy01.neotel.nr/mis-reports/device/get/alldevice/byAgent/dateRange?search=${serach}&startDate=${startdate}&endDate=${enddate}`;
