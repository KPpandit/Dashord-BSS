...
const Specialoffers = (props) => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const response = await axios.get('http://172.17.1.20:8082/voucher/api/all/special/offers', {
                    headers: {
    ...
    const handleConfirmDelete = () => {
        ...
        axios.delete(`http://172.17.1.11:9696/api/hss/detail/delete?imsi=${recordIdToDelete}&msisdn=${recordMsisdnToDelete}`, {
            headers: {
                Authorization: `Bearer ${tokenValue}`,
                "Accept": "application/json",
                "Content-Type": "application/json"
        ...
        if (selectedRecord) {
            return (
                <Grid>
                            ...
                            <Grid container>
                                <Grid item xs={12} paddingLeft={1}>
                                    ...
                                    <Box sx={{ p: 1 }}>
                                        <Grid container>
                                            <Grid item xs={4}>
                                                <Typography sx={{ fontWeight: '480', fontSize: '17px', textAlign: 'left' }}>  Unique ID :</Typography>
                                            </Grid>
                                        ...
                                        <Grid container>
                                            ...
                                            <Grid item xs={7} alignItems={'left'} sx={{ marginLeft: 0 }} >
                                                ...
                                                >
                                                    ...
                                                    {String(selectedRecord.planPrice)}
                                                </Typography>
                                            </Grid>
                                        </Grid>
                                    </Box>
                    ...
                    >
                        <BuyVoucher  selectedRecordId={selectedRecord} />
                    </Popup>
                ...
                <Box component="main" sx={{ flexGrow: 1, p: 1, width: '100%' }}>
                    <Paper elevation={10} sx={{ padding: 1, margin: 1, backgroundColor: 'white', marginLeft: -0.8, marginRight: 1 }}>
                        <Grid>
                            ...
                            >Voucher Special Offer</Typography>
                        </Grid>
                    </Paper>
                </Box>
