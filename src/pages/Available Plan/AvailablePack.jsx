...
export default function AvailablePlan() {
    ...
    useEffect(() => {
        ...
        fetch('http://172.17.1.11:9699/api/postpaid/packs/get/all')
    ...
    useEffect(() => {
        ...
        if (tabList.length > 0) {
            const promises = tabList.map(category =>
                fetch(`http://172.17.1.11:9699/api/postpaid/packs/get/all?category_name=${category}`)
                    .then(response => response.json())
                                                    ...
                                                    <Grid container spacing={2}>
                                                        ...
                                                        <Grid item xs={6} sx={{ marginTop: 1 }}>
                                                            <Grid container spacing={1}>
                                                                ...
                                                                <Grid item xs={12}>
                                                                    <Typography>{plan.call_balance} mins</Typography>
                                                                </Grid>
                                                            </Grid>
                                                        </Grid>
                                                        <Grid item xs={6} sx={{ marginTop: 1 }}>
                                                            <Grid container spacing={1}>
                                                                ...
                                                                <Grid item xs={12}>
                                                                    <Typography>{plan.sms_balance}</Typography>
                                                                </Grid>
                                                            </Grid>
                                                        </Grid>
